...
Here is an interactive example of the well-known \passthrough{\lstinline!iris!} data set that has been added as a dependency to this notebook. Clicking the disclosure triangles will expand the data structure.
...
Then, a \passthrough{\lstinline!sparkline!} function is defined that generates the graph (using \passthrough{\lstinline!clerk/vl!}) to be embedded into each table row later:
...
\hypertarget{id}{%
\section{Related \& Future Work}\label{id}}
